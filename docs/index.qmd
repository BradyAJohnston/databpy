...
::: {.callout-tip}
# New to databpy?
Check out the [**Attributes guid**](attributes.qmd) for a comprehensive overview of the attribute system, including performance tips, best practices, and examples for all attribute types.
:::
