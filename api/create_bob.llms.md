...
| name | [str](https://docs.python.org/3/builtins/stdtypes.html#str) | Name of the created object. Default is “NewObject”. | `'NewObject'` |
...
| uuid | [str](https://docs.python.org/3/builtins/stdtypes.html#str) or None | Directly set the UUID on the resulting BlenderObject. Default is None. | `None` |
